...
// display function. Write to full-screen.
// Assumes input data has already been checked for length and content
// (i.e., is DISPLAY_SIZE or greater in length and contains only valid display bytes, clock points accounted for)
// NB added after-market, Nov. 2022, by Nate Cope 
void TM1637::direct_display(uint8_t DispData[])
{
  ...
  this->stop();           
  this->start();          
  this->writeByte(this->Cmd_SetAddr);
